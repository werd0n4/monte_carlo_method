...
//czesc odpowiedzialna za handling error�w w cze�ci GPU ********************
...
__global__ void parrelCuda(int gpu_size,unsigned long seed, double A, double B, double min_Y, double max_Y, int* c, int size) {
	...
	//4. przyr�wnaj f(x) z wylosowanym Y
	//5. zwr�c wynik
...
int main() {
	...
	//Dok�adno��- liczba n losowanych punkt�w-tutaj potem ustawi� znacznie wi�cej
	//Obecnie dotyczy jedynie losowania punkt�w w polu, a nie granic pola
	//n = 200;
	...
	//opis dzia�ania: wylosuj N punktow, dzi�ki temu wyznacz granice Y prostok�ta- zr�wnolegli� w tym miejscu
	randomY_min = -2;
...
int main23() {
	...
	//TODO 
	//Tutaj drugie zr�wnoleglenie- losowa� na GPU 10000000 punkt�w i sprawdza� warto�� ifContains
	//trzeba jako� przerobi� i randompoint- uzy� cuda random
	//i ifContains- zapisa� gdzie� warto��i przedzia��w aby GPU ca� czas mia�o do nich dost�p?
	score = 0;//co to
